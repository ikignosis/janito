...
For direct execution, use: python -m janito.tools.files.create_directory [args]
...
class CreateDirectory(BaseTool):
    ...
    def run(
        ...
        try:
            ...
            self.report_result("Successfully created directory")
            ...
            self.report_error(f"OS Error creating directory: {e!s}")
            return {
                "success": False,
                "error": f"OS Error creating directory: {e!s}",
                "directory": directory,
                "parents": parents,
                "exist_ok": exist_ok,
            }
