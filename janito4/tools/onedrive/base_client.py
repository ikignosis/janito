...
class OneDriveBaseClient:
    ...
    Authentication:
        1. First time: Run `janito4 --onedrive-auth` to authenticate
    ...
    def _get_required_secrets(self) -> str:
        ...
        if not client_id:
            raise ValueError(
                ...
                "7. Run: janito4 --set-secret azure_client_id=your-client-id\n"
                "8. Run: janito4 --onedrive-auth\n"
            )
