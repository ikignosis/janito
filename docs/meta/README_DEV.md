...
See the Using Dev Version page in the documentation navigation for instructions on installing and using the latest development version of this project from GitHub.
