...
- `kimi-k2-thinking` - Advanced thinking model with 256k context window and enhanced reasoning capabilities

To select a model:

```bash
janito -p moonshot -m kimi-k2-thinking "Your prompt here"
```
